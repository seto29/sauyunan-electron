                    ...
                    <CCol xs="20" md="10">
                        <CForm action="" method="post" className="form-horizontal">
                            ...
                            <CFormGroup row>
                                ...
                                <CCol xs="12" md="9">
                                    <CInput type="text" style={{textTransform:'uppercase'}} placeholder="Nama Barang" name="nama" value={props.productAdd.nama} onChange={(e)=> props.handleAddInput(e)} />
                                </CCol>
                            </CFormGroup>
                            <CFormGroup row>
                                <CCol md="3">
                                ...
                                <CCol xs="12" md="9">
                                    <CInput type="text" style={{textTransform:'uppercase'}} placeholder="Part Number" name="part_number" value={props.productAdd.part_number} onChange={(e)=> props.handleAddInput(e)} />
                                </CCol>
                            </CFormGroup>
                            <CFormGroup row>
                                <CCol md="3">
                                ...
                                <CCol xs="12" md="9">
                                    <CInput type="text" style={{textTransform:'uppercase'}} placeholder="Merek" name="merk" value={props.productAdd.merk} onChange={(e)=> props.handleAddInput(e)} />
                                </CCol>
                            </CFormGroup>
                            <CFormGroup row>
                                    <CCol md="3">
                            ...
                            <CFormGroup row>
                                ...
                                <CCol xs="12" md="9">
                                    <CInput type="text" placeholder="Barcode" style={{textTransform:'uppercase'}} name="barcode" value={props.productAdd.barcode} onChange={(e)=> props.handleAddInput(e)} />
                                </CCol>
                            </CFormGroup>
                            <CFormGroup row>
                                <CCol md="3">
