    ...
    const [selectGiro, setSelectGiro] = useState({});
      ...
      useEffect(()=>{
          ...
          props.giro && props.giro.map(value => {
              list[i] = {
                  id: value.kode_transaksi, value: value.kode_transaksi, label: value.kode_transaksi+" "+value.kode_penjualan, data:value,
                  target: { type: 'select', name: 'list',id: value.kode_transaksi, value: value.kode_transaksi, label: value.kode_transaksi+" "+value.kode_penjualan, data:value }
              }
              i++;
              return i;
          })
